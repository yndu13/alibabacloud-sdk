...
namespace AlibabaCloud\SDK\vod\V20170314\Models\DescribeVodDomainTopReferVisitResponse\topReferList;
...
class referList extends Model {
    ...
    public function validate() {
        Model::validateRequired('referDetail', $this->referDetail, true);
