...
use AlibabaCloud\SDK\vod\V20170314\Models\DescribeUserUvByDayResponse\userPlayStatisticsInfos;

class DescribeUserUvByDayResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
     ...
     * @var DescribeUserUvByDayResponse.userPlayStatisticsInfos
     */
