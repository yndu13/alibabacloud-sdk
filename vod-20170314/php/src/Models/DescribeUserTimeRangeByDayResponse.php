...
use AlibabaCloud\SDK\vod\V20170314\Models\DescribeUserTimeRangeByDayResponse\userPlayStatisticsInfos;

class DescribeUserTimeRangeByDayResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
     ...
     * @var DescribeUserTimeRangeByDayResponse.userPlayStatisticsInfos
     */
