...
namespace AlibabaCloud\SDK\vod\V20170314\Models\GetTemplateGroupResponse\templateGroup\templates;
...
class template extends Model {
    ...
    public function validate() {
        ...
        Model::validateRequired('mediaDefinition', $this->mediaDefinition, true);
        ...
        Model::validateRequired('useWaterMark', $this->useWaterMark, true);
