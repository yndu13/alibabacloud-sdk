...
use AlibabaCloud\SDK\vod\V20170314\Models\DeleteVideoTagResponse\mediaInfoDTO;

class DeleteVideoTagResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
     ...
     * @var DeleteVideoTagResponse.mediaInfoDTO
     */
    public $mediaInfoDTO;
