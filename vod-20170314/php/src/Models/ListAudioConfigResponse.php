...
use AlibabaCloud\SDK\vod\V20170314\Models\ListAudioConfigResponse\configs;

class ListAudioConfigResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
        'configs' => 'Configs',
    ];
     ...
     * @var ListAudioConfigResponse.configs
     */
    public $configs;
