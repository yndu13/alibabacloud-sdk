...
use AlibabaCloud\SDK\vod\V20170314\Models\GetAudioTemplateResponse\audio;

class GetAudioTemplateResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
        'audio' => 'Audio',
    ];
     ...
     * @var GetAudioTemplateResponse.audio
     */
    public $audio;
