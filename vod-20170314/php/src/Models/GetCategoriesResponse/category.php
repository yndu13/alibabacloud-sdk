...
namespace AlibabaCloud\SDK\vod\V20170314\Models\GetCategoriesResponse;
...
class category extends Model {
    ...
    public function validate() {
        ...
        Model::validateRequired('grandId', $this->grandId, true);
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['GrandId'])){
            $model->grandId = $map['GrandId'];
        }
        if(isset($map['Type'])){
            $model->type = $map['Type'];
        }
