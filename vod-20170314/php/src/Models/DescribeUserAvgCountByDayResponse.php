...
use AlibabaCloud\SDK\vod\V20170314\Models\DescribeUserAvgCountByDayResponse\userPlayStatisticsInfos;

class DescribeUserAvgCountByDayResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
     ...
     * @var DescribeUserAvgCountByDayResponse.userPlayStatisticsInfos
     */
