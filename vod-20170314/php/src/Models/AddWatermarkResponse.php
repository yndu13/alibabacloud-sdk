...
use AlibabaCloud\SDK\vod\V20170314\Models\AddWatermarkResponse\watermark;
use AlibabaCloud\SDK\vod\V20170314\Models\AddWatermarkResponse\watermarkInfo;
...
class AddWatermarkResponse extends Model {
     ...
     * @var AddWatermarkResponse.watermark
     */
    public $watermark;

    /**
     * @description data.watermarkDto
     * @var AddWatermarkResponse.watermarkInfo
     */
