...
use AlibabaCloud\SDK\vod\V20170314\Models\AddAudioTemplateResponse\audio;

class AddAudioTemplateResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
        'audio' => 'Audio',
    ];
     ...
     * @var AddAudioTemplateResponse.audio
     */
    public $audio;
