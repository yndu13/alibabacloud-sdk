...
use AlibabaCloud\SDK\vod\V20170314\Models\DescribeUserAvgTimeByDayResponse\userPlayStatisticsInfos;

class DescribeUserAvgTimeByDayResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
     ...
     * @var DescribeUserAvgTimeByDayResponse.userPlayStatisticsInfos
     */
