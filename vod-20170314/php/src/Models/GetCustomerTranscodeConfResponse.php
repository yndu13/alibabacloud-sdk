...
use AlibabaCloud\SDK\vod\V20170314\Models\GetCustomerTranscodeConfResponse\templates;

class GetCustomerTranscodeConfResponse extends Model {
    protected $_name = [
        'requestId' => 'RequestId',
        'templates' => 'Templates',
    ];
     ...
     * @var GetCustomerTranscodeConfResponse.templates
     */
    public $templates;
