...
use AlibabaCloud\SDK\vod\V20170314\Models\DescribeVodDomainISPDataResponse\value;
...
class DescribeVodDomainISPDataResponse extends Model {
    ...
    /**
     * @description data.content.ispDatas
     * @var DescribeVodDomainISPDataResponse.value
     */
    public $value;
