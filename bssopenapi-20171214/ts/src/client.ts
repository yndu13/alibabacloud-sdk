...
export default class Client extends RPC {
  ...
  async queryRIUtilizationDetailEx(request: QueryRIUtilizationDetailRequest, runtime: $Util.RuntimeOptions): Promise<QueryRIUtilizationDetailResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryRIUtilizationDetailResponse>(await this.doRequest("QueryRIUtilizationDetail", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryRIUtilizationDetailResponse({}));
  }

  async queryRIUtilizationDetail(request: QueryRIUtilizationDetailRequest): Promise<QueryRIUtilizationDetailResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryRIUtilizationDetailEx(request, runtime);
  }

  async queryBillToOSSSubscriptionEx(request: QueryBillToOSSSubscriptionRequest, runtime: $Util.RuntimeOptions): Promise<QueryBillToOSSSubscriptionResponse> {
    Util.validateModel(request);
  ...
  async queryBillToOSSSubscription(request: QueryBillToOSSSubscriptionRequest): Promise<QueryBillToOSSSubscriptionResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryBillToOSSSubscriptionEx(request, runtime);
  }

  async queryAccountBillEx(request: QueryAccountBillRequest, runtime: $Util.RuntimeOptions): Promise<QueryAccountBillResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryAccountBillResponse>(await this.doRequest("QueryAccountBill", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryAccountBillResponse({}));
  }

  async queryAccountBill(request: QueryAccountBillRequest): Promise<QueryAccountBillResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryAccountBillEx(request, runtime);
  }

  async createCostUnitEx(request: CreateCostUnitRequest, runtime: $Util.RuntimeOptions): Promise<CreateCostUnitResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateCostUnitResponse>(await this.doRequest("CreateCostUnit", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new CreateCostUnitResponse({}));
  }

  async createCostUnit(request: CreateCostUnitRequest): Promise<CreateCostUnitResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.createCostUnitEx(request, runtime);
  }

  async modifyCostUnitEx(request: ModifyCostUnitRequest, runtime: $Util.RuntimeOptions): Promise<ModifyCostUnitResponse> {
    Util.validateModel(request);
    return $tea.cast<ModifyCostUnitResponse>(await this.doRequest("ModifyCostUnit", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new ModifyCostUnitResponse({}));
  }

  async modifyCostUnit(request: ModifyCostUnitRequest): Promise<ModifyCostUnitResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.modifyCostUnitEx(request, runtime);
  }

  async queryCostUnitEx(request: QueryCostUnitRequest, runtime: $Util.RuntimeOptions): Promise<QueryCostUnitResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryCostUnitResponse>(await this.doRequest("QueryCostUnit", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryCostUnitResponse({}));
  }

  async queryCostUnit(request: QueryCostUnitRequest): Promise<QueryCostUnitResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryCostUnitEx(request, runtime);
  }

  async deleteCostUnitEx(request: DeleteCostUnitRequest, runtime: $Util.RuntimeOptions): Promise<DeleteCostUnitResponse> {
    Util.validateModel(request);
    return $tea.cast<DeleteCostUnitResponse>(await this.doRequest("DeleteCostUnit", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new DeleteCostUnitResponse({}));
  }

  async deleteCostUnit(request: DeleteCostUnitRequest): Promise<DeleteCostUnitResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.deleteCostUnitEx(request, runtime);
  }

  async allocateCostUnitResourceEx(request: AllocateCostUnitResourceRequest, runtime: $Util.RuntimeOptions): Promise<AllocateCostUnitResourceResponse> {
    Util.validateModel(request);
    return $tea.cast<AllocateCostUnitResourceResponse>(await this.doRequest("AllocateCostUnitResource", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new AllocateCostUnitResourceResponse({}));
  }

  async allocateCostUnitResource(request: AllocateCostUnitResourceRequest): Promise<AllocateCostUnitResourceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.allocateCostUnitResourceEx(request, runtime);
  }

  async queryCostUnitResourceEx(request: QueryCostUnitResourceRequest, runtime: $Util.RuntimeOptions): Promise<QueryCostUnitResourceResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryCostUnitResourceResponse>(await this.doRequest("QueryCostUnitResource", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryCostUnitResourceResponse({}));
  }

  async queryCostUnitResource(request: QueryCostUnitResourceRequest): Promise<QueryCostUnitResourceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryCostUnitResourceEx(request, runtime);
  }

  async renewResourcePackageEx(request: RenewResourcePackageRequest, runtime: $Util.RuntimeOptions): Promise<RenewResourcePackageResponse> {
    Util.validateModel(request);
    return $tea.cast<RenewResourcePackageResponse>(await this.doRequest("RenewResourcePackage", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new RenewResourcePackageResponse({}));
  }

  async renewResourcePackage(request: RenewResourcePackageRequest): Promise<RenewResourcePackageResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.renewResourcePackageEx(request, runtime);
  }

  async upgradeResourcePackageEx(request: UpgradeResourcePackageRequest, runtime: $Util.RuntimeOptions): Promise<UpgradeResourcePackageResponse> {
    Util.validateModel(request);
    return $tea.cast<UpgradeResourcePackageResponse>(await this.doRequest("UpgradeResourcePackage", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new UpgradeResourcePackageResponse({}));
  }

  async upgradeResourcePackage(request: UpgradeResourcePackageRequest): Promise<UpgradeResourcePackageResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.upgradeResourcePackageEx(request, runtime);
  }

  async createAgAccountEx(request: CreateAgAccountRequest, runtime: $Util.RuntimeOptions): Promise<CreateAgAccountResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateAgAccountResponse>(await this.doRequest("CreateAgAccount", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new CreateAgAccountResponse({}));
  }

  async createAgAccount(request: CreateAgAccountRequest): Promise<CreateAgAccountResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.createAgAccountEx(request, runtime);
  }

  async getCustomerAccountInfoEx(request: GetCustomerAccountInfoRequest, runtime: $Util.RuntimeOptions): Promise<GetCustomerAccountInfoResponse> {
    Util.validateModel(request);
    return $tea.cast<GetCustomerAccountInfoResponse>(await this.doRequest("GetCustomerAccountInfo", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new GetCustomerAccountInfoResponse({}));
  }

  async getCustomerAccountInfo(request: GetCustomerAccountInfoRequest): Promise<GetCustomerAccountInfoResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getCustomerAccountInfoEx(request, runtime);
  }

  async getCustomerListEx(request: GetCustomerListRequest, runtime: $Util.RuntimeOptions): Promise<GetCustomerListResponse> {
    Util.validateModel(request);
  ...
  async getCustomerList(request: GetCustomerListRequest): Promise<GetCustomerListResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getCustomerListEx(request, runtime);
  }

  async changeResellerConsumeAmountEx(request: ChangeResellerConsumeAmountRequest, runtime: $Util.RuntimeOptions): Promise<ChangeResellerConsumeAmountResponse> {
    Util.validateModel(request);
    return $tea.cast<ChangeResellerConsumeAmountResponse>(await this.doRequest("ChangeResellerConsumeAmount", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new ChangeResellerConsumeAmountResponse({}));
  }

  async changeResellerConsumeAmount(request: ChangeResellerConsumeAmountRequest): Promise<ChangeResellerConsumeAmountResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.changeResellerConsumeAmountEx(request, runtime);
  }

  async setResellerUserStatusEx(request: SetResellerUserStatusRequest, runtime: $Util.RuntimeOptions): Promise<SetResellerUserStatusResponse> {
    Util.validateModel(request);
    return $tea.cast<SetResellerUserStatusResponse>(await this.doRequest("SetResellerUserStatus", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new SetResellerUserStatusResponse({}));
  }

  async setResellerUserStatus(request: SetResellerUserStatusRequest): Promise<SetResellerUserStatusResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.setResellerUserStatusEx(request, runtime);
  }

  async createResellerUserQuotaEx(request: CreateResellerUserQuotaRequest, runtime: $Util.RuntimeOptions): Promise<CreateResellerUserQuotaResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateResellerUserQuotaResponse>(await this.doRequest("CreateResellerUserQuota", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new CreateResellerUserQuotaResponse({}));
  }

  async createResellerUserQuota(request: CreateResellerUserQuotaRequest): Promise<CreateResellerUserQuotaResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.createResellerUserQuotaEx(request, runtime);
  }

  async setResellerUserQuotaEx(request: SetResellerUserQuotaRequest, runtime: $Util.RuntimeOptions): Promise<SetResellerUserQuotaResponse> {
    Util.validateModel(request);
    return $tea.cast<SetResellerUserQuotaResponse>(await this.doRequest("SetResellerUserQuota", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new SetResellerUserQuotaResponse({}));
  }

  async setResellerUserQuota(request: SetResellerUserQuotaRequest): Promise<SetResellerUserQuotaResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.setResellerUserQuotaEx(request, runtime);
  }

  async queryResellerAvailableQuotaEx(request: QueryResellerAvailableQuotaRequest, runtime: $Util.RuntimeOptions): Promise<QueryResellerAvailableQuotaResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryResellerAvailableQuotaResponse>(await this.doRequest("QueryResellerAvailableQuota", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryResellerAvailableQuotaResponse({}));
  }

  async queryResellerAvailableQuota(request: QueryResellerAvailableQuotaRequest): Promise<QueryResellerAvailableQuotaResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryResellerAvailableQuotaEx(request, runtime);
  }

  async setResellerUserAlarmThresholdEx(request: SetResellerUserAlarmThresholdRequest, runtime: $Util.RuntimeOptions): Promise<SetResellerUserAlarmThresholdResponse> {
    Util.validateModel(request);
    return $tea.cast<SetResellerUserAlarmThresholdResponse>(await this.doRequest("SetResellerUserAlarmThreshold", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new SetResellerUserAlarmThresholdResponse({}));
  }
  ...
  async setResellerUserAlarmThreshold(request: SetResellerUserAlarmThresholdRequest): Promise<SetResellerUserAlarmThresholdResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.setResellerUserAlarmThresholdEx(request, runtime);
  }

  async queryAccountTransactionsEx(request: QueryAccountTransactionsRequest, runtime: $Util.RuntimeOptions): Promise<QueryAccountTransactionsResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryAccountTransactionsResponse>(await this.doRequest("QueryAccountTransactions", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryAccountTransactionsResponse({}));
  }

  async queryAccountTransactions(request: QueryAccountTransactionsRequest): Promise<QueryAccountTransactionsResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryAccountTransactionsEx(request, runtime);
  }

  async unsubscribeBillToOSSEx(request: UnsubscribeBillToOSSRequest, runtime: $Util.RuntimeOptions): Promise<UnsubscribeBillToOSSResponse> {
    Util.validateModel(request);
    return $tea.cast<UnsubscribeBillToOSSResponse>(await this.doRequest("UnsubscribeBillToOSS", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new UnsubscribeBillToOSSResponse({}));
  }

  async unsubscribeBillToOSS(request: UnsubscribeBillToOSSRequest): Promise<UnsubscribeBillToOSSResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.unsubscribeBillToOSSEx(request, runtime);
  }

  async subscribeBillToOSSEx(request: SubscribeBillToOSSRequest, runtime: $Util.RuntimeOptions): Promise<SubscribeBillToOSSResponse> {
    Util.validateModel(request);
    return $tea.cast<SubscribeBillToOSSResponse>(await this.doRequest("SubscribeBillToOSS", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new SubscribeBillToOSSResponse({}));
  }

  async subscribeBillToOSS(request: SubscribeBillToOSSRequest): Promise<SubscribeBillToOSSResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.subscribeBillToOSSEx(request, runtime);
  }

  async queryUserOmsDataEx(request: QueryUserOmsDataRequest, runtime: $Util.RuntimeOptions): Promise<QueryUserOmsDataResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryUserOmsDataResponse>(await this.doRequest("QueryUserOmsData", "HTTPS", "GET", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryUserOmsDataResponse({}));
  }

  async queryUserOmsData(request: QueryUserOmsDataRequest): Promise<QueryUserOmsDataResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryUserOmsDataEx(request, runtime);
  }

  async cancelOrderEx(request: CancelOrderRequest, runtime: $Util.RuntimeOptions): Promise<CancelOrderResponse> {
    Util.validateModel(request);
    return $tea.cast<CancelOrderResponse>(await this.doRequest("CancelOrder", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new CancelOrderResponse({}));
  }

  async cancelOrder(request: CancelOrderRequest): Promise<CancelOrderResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.cancelOrderEx(request, runtime);
  }

  async applyInvoiceEx(request: ApplyInvoiceRequest, runtime: $Util.RuntimeOptions): Promise<ApplyInvoiceResponse> {
    Util.validateModel(request);
    return $tea.cast<ApplyInvoiceResponse>(await this.doRequest("ApplyInvoice", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new ApplyInvoiceResponse({}));
  }

  async applyInvoice(request: ApplyInvoiceRequest): Promise<ApplyInvoiceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.applyInvoiceEx(request, runtime);
  }

  async queryCustomerAddressListEx(request: QueryCustomerAddressListRequest, runtime: $Util.RuntimeOptions): Promise<QueryCustomerAddressListResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryCustomerAddressListResponse>(await this.doRequest("QueryCustomerAddressList", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryCustomerAddressListResponse({}));
  }

  async queryCustomerAddressList(request: QueryCustomerAddressListRequest): Promise<QueryCustomerAddressListResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryCustomerAddressListEx(request, runtime);
  }

  async queryEvaluateListEx(request: QueryEvaluateListRequest, runtime: $Util.RuntimeOptions): Promise<QueryEvaluateListResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryEvaluateListResponse>(await this.doRequest("QueryEvaluateList", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryEvaluateListResponse({}));
  }

  async queryEvaluateList(request: QueryEvaluateListRequest): Promise<QueryEvaluateListResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryEvaluateListEx(request, runtime);
  }

  async queryInvoicingCustomerListEx(request: QueryInvoicingCustomerListRequest, runtime: $Util.RuntimeOptions): Promise<QueryInvoicingCustomerListResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryInvoicingCustomerListResponse>(await this.doRequest("QueryInvoicingCustomerList", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryInvoicingCustomerListResponse({}));
  }

  async queryInvoicingCustomerList(request: QueryInvoicingCustomerListRequest): Promise<QueryInvoicingCustomerListResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryInvoicingCustomerListEx(request, runtime);
  }

  async queryBillOverviewEx(request: QueryBillOverviewRequest, runtime: $Util.RuntimeOptions): Promise<QueryBillOverviewResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryBillOverviewResponse>(await this.doRequest("QueryBillOverview", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryBillOverviewResponse({}));
  }

  async queryBillOverview(request: QueryBillOverviewRequest): Promise<QueryBillOverviewResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryBillOverviewEx(request, runtime);
  }

  async queryBillEx(request: QueryBillRequest, runtime: $Util.RuntimeOptions): Promise<QueryBillResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryBillResponse>(await this.doRequest("QueryBill", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryBillResponse({}));
  }

  async queryBill(request: QueryBillRequest): Promise<QueryBillResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryBillEx(request, runtime);
  }

  async queryInstanceBillEx(request: QueryInstanceBillRequest, runtime: $Util.RuntimeOptions): Promise<QueryInstanceBillResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryInstanceBillResponse>(await this.doRequest("QueryInstanceBill", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryInstanceBillResponse({}));
  }

  async queryInstanceBill(request: QueryInstanceBillRequest): Promise<QueryInstanceBillResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryInstanceBillEx(request, runtime);
  }

  async enableBillGenerationEx(request: EnableBillGenerationRequest, runtime: $Util.RuntimeOptions): Promise<EnableBillGenerationResponse> {
    Util.validateModel(request);
    return $tea.cast<EnableBillGenerationResponse>(await this.doRequest("EnableBillGeneration", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new EnableBillGenerationResponse({}));
  }

  async enableBillGeneration(request: EnableBillGenerationRequest): Promise<EnableBillGenerationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.enableBillGenerationEx(request, runtime);
  }

  async queryRedeemEx(request: QueryRedeemRequest, runtime: $Util.RuntimeOptions): Promise<QueryRedeemResponse> {
    Util.validateModel(request);
  ...
  async queryRedeem(request: QueryRedeemRequest): Promise<QueryRedeemResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryRedeemEx(request, runtime);
  }

  async convertChargeTypeEx(request: ConvertChargeTypeRequest, runtime: $Util.RuntimeOptions): Promise<ConvertChargeTypeResponse> {
    Util.validateModel(request);
    return $tea.cast<ConvertChargeTypeResponse>(await this.doRequest("ConvertChargeType", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new ConvertChargeTypeResponse({}));
  }

  async convertChargeType(request: ConvertChargeTypeRequest): Promise<ConvertChargeTypeResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.convertChargeTypeEx(request, runtime);
  }

  async createInstanceEx(request: CreateInstanceRequest, runtime: $Util.RuntimeOptions): Promise<CreateInstanceResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateInstanceResponse>(await this.doRequest("CreateInstance", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new CreateInstanceResponse({}));
  }
  ...
  async modifyInstanceEx(request: ModifyInstanceRequest, runtime: $Util.RuntimeOptions): Promise<ModifyInstanceResponse> {
    Util.validateModel(request);
    return $tea.cast<ModifyInstanceResponse>(await this.doRequest("ModifyInstance", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new ModifyInstanceResponse({}));
  }
  ...
  async describePricingModuleEx(request: DescribePricingModuleRequest, runtime: $Util.RuntimeOptions): Promise<DescribePricingModuleResponse> {
    Util.validateModel(request);
    return $tea.cast<DescribePricingModuleResponse>(await this.doRequest("DescribePricingModule", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new DescribePricingModuleResponse({}));
  }

  async describePricingModule(request: DescribePricingModuleRequest): Promise<DescribePricingModuleResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.describePricingModuleEx(request, runtime);
  }

  async queryProductListEx(request: QueryProductListRequest, runtime: $Util.RuntimeOptions): Promise<QueryProductListResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryProductListResponse>(await this.doRequest("QueryProductList", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryProductListResponse({}));
  }

  async queryProductList(request: QueryProductListRequest): Promise<QueryProductListResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryProductListEx(request, runtime);
  }

  async queryInstanceGaapCostEx(request: QueryInstanceGaapCostRequest, runtime: $Util.RuntimeOptions): Promise<QueryInstanceGaapCostResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryInstanceGaapCostResponse>(await this.doRequest("QueryInstanceGaapCost", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryInstanceGaapCostResponse({}));
  }

  async queryInstanceGaapCost(request: QueryInstanceGaapCostRequest): Promise<QueryInstanceGaapCostResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryInstanceGaapCostEx(request, runtime);
  }

  async renewInstanceEx(request: RenewInstanceRequest, runtime: $Util.RuntimeOptions): Promise<RenewInstanceResponse> {
    Util.validateModel(request);
    return $tea.cast<RenewInstanceResponse>(await this.doRequest("RenewInstance", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new RenewInstanceResponse({}));
  }

  async renewInstance(request: RenewInstanceRequest): Promise<RenewInstanceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.renewInstanceEx(request, runtime);
  }

  async getOrderDetailEx(request: GetOrderDetailRequest, runtime: $Util.RuntimeOptions): Promise<GetOrderDetailResponse> {
    Util.validateModel(request);
    return $tea.cast<GetOrderDetailResponse>(await this.doRequest("GetOrderDetail", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new GetOrderDetailResponse({}));
  }

  async getOrderDetail(request: GetOrderDetailRequest): Promise<GetOrderDetailResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getOrderDetailEx(request, runtime);
  }

  async queryOrdersEx(request: QueryOrdersRequest, runtime: $Util.RuntimeOptions): Promise<QueryOrdersResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryOrdersResponse>(await this.doRequest("QueryOrders", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryOrdersResponse({}));
  }

  async queryOrders(request: QueryOrdersRequest): Promise<QueryOrdersResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryOrdersEx(request, runtime);
  }

  async queryMonthlyInstanceConsumptionEx(request: QueryMonthlyInstanceConsumptionRequest, runtime: $Util.RuntimeOptions): Promise<QueryMonthlyInstanceConsumptionResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryMonthlyInstanceConsumptionResponse>(await this.doRequest("QueryMonthlyInstanceConsumption", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryMonthlyInstanceConsumptionResponse({}));
  }
  ...
  async queryMonthlyInstanceConsumption(request: QueryMonthlyInstanceConsumptionRequest): Promise<QueryMonthlyInstanceConsumptionResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryMonthlyInstanceConsumptionEx(request, runtime);
  }

  async querySettlementBillEx(request: QuerySettlementBillRequest, runtime: $Util.RuntimeOptions): Promise<QuerySettlementBillResponse> {
    Util.validateModel(request);
    return $tea.cast<QuerySettlementBillResponse>(await this.doRequest("QuerySettlementBill", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QuerySettlementBillResponse({}));
  }

  async querySettlementBill(request: QuerySettlementBillRequest): Promise<QuerySettlementBillResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.querySettlementBillEx(request, runtime);
  }

  async queryMonthlyBillEx(request: QueryMonthlyBillRequest, runtime: $Util.RuntimeOptions): Promise<QueryMonthlyBillResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryMonthlyBillResponse>(await this.doRequest("QueryMonthlyBill", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryMonthlyBillResponse({}));
  }

  async queryMonthlyBill(request: QueryMonthlyBillRequest): Promise<QueryMonthlyBillResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryMonthlyBillEx(request, runtime);
  }

  async setRenewalEx(request: SetRenewalRequest, runtime: $Util.RuntimeOptions): Promise<SetRenewalResponse> {
    Util.validateModel(request);
    return $tea.cast<SetRenewalResponse>(await this.doRequest("SetRenewal", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new SetRenewalResponse({}));
  }

  async setRenewal(request: SetRenewalRequest): Promise<SetRenewalResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.setRenewalEx(request, runtime);
  }

  async queryAvailableInstancesEx(request: QueryAvailableInstancesRequest, runtime: $Util.RuntimeOptions): Promise<QueryAvailableInstancesResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryAvailableInstancesResponse>(await this.doRequest("QueryAvailableInstances", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryAvailableInstancesResponse({}));
  }

  async queryAvailableInstances(request: QueryAvailableInstancesRequest): Promise<QueryAvailableInstancesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryAvailableInstancesEx(request, runtime);
  }

  async createResourcePackageEx(request: CreateResourcePackageRequest, runtime: $Util.RuntimeOptions): Promise<CreateResourcePackageResponse> {
    Util.validateModel(request);
    return $tea.cast<CreateResourcePackageResponse>(await this.doRequest("CreateResourcePackage", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new CreateResourcePackageResponse({}));
  }

  async createResourcePackage(request: CreateResourcePackageRequest): Promise<CreateResourcePackageResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.createResourcePackageEx(request, runtime);
  }

  async queryResourcePackageInstancesEx(request: QueryResourcePackageInstancesRequest, runtime: $Util.RuntimeOptions): Promise<QueryResourcePackageInstancesResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryResourcePackageInstancesResponse>(await this.doRequest("QueryResourcePackageInstances", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryResourcePackageInstancesResponse({}));
  }
  ...
  async queryResourcePackageInstances(request: QueryResourcePackageInstancesRequest): Promise<QueryResourcePackageInstancesResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryResourcePackageInstancesEx(request, runtime);
  }

  async getResourcePackagePriceEx(request: GetResourcePackagePriceRequest, runtime: $Util.RuntimeOptions): Promise<GetResourcePackagePriceResponse> {
    Util.validateModel(request);
    return $tea.cast<GetResourcePackagePriceResponse>(await this.doRequest("GetResourcePackagePrice", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new GetResourcePackagePriceResponse({}));
  }

  async getResourcePackagePrice(request: GetResourcePackagePriceRequest): Promise<GetResourcePackagePriceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getResourcePackagePriceEx(request, runtime);
  }

  async getSubscriptionPriceEx(request: GetSubscriptionPriceRequest, runtime: $Util.RuntimeOptions): Promise<GetSubscriptionPriceResponse> {
    Util.validateModel(request);
    return $tea.cast<GetSubscriptionPriceResponse>(await this.doRequest("GetSubscriptionPrice", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new GetSubscriptionPriceResponse({}));
  }

  async getSubscriptionPrice(request: GetSubscriptionPriceRequest): Promise<GetSubscriptionPriceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getSubscriptionPriceEx(request, runtime);
  }

  async getPayAsYouGoPriceEx(request: GetPayAsYouGoPriceRequest, runtime: $Util.RuntimeOptions): Promise<GetPayAsYouGoPriceResponse> {
    Util.validateModel(request);
    return $tea.cast<GetPayAsYouGoPriceResponse>(await this.doRequest("GetPayAsYouGoPrice", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new GetPayAsYouGoPriceResponse({}));
  }

  async getPayAsYouGoPrice(request: GetPayAsYouGoPriceRequest): Promise<GetPayAsYouGoPriceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.getPayAsYouGoPriceEx(request, runtime);
  }

  async queryPrepaidCardsEx(request: QueryPrepaidCardsRequest, runtime: $Util.RuntimeOptions): Promise<QueryPrepaidCardsResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryPrepaidCardsResponse>(await this.doRequest("QueryPrepaidCards", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryPrepaidCardsResponse({}));
  }

  async queryPrepaidCards(request: QueryPrepaidCardsRequest): Promise<QueryPrepaidCardsResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryPrepaidCardsEx(request, runtime);
  }

  async queryCashCouponsEx(request: QueryCashCouponsRequest, runtime: $Util.RuntimeOptions): Promise<QueryCashCouponsResponse> {
    Util.validateModel(request);
    return $tea.cast<QueryCashCouponsResponse>(await this.doRequest("QueryCashCoupons", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new QueryCashCouponsResponse({}));
  }

  async queryCashCoupons(request: QueryCashCouponsRequest): Promise<QueryCashCouponsResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryCashCouponsEx(request, runtime);
  }

  async queryAccountBalanceEx(request: QueryAccountBalanceRequest, runtime: $Util.RuntimeOptions): Promise<QueryAccountBalanceResponse> {
    Util.validateModel(request);
  ...
  async queryAccountBalance(request: QueryAccountBalanceRequest): Promise<QueryAccountBalanceResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.queryAccountBalanceEx(request, runtime);
  }

  async describeResourcePackageProductEx(request: DescribeResourcePackageProductRequest, runtime: $Util.RuntimeOptions): Promise<DescribeResourcePackageProductResponse> {
    Util.validateModel(request);
    return $tea.cast<DescribeResourcePackageProductResponse>(await this.doRequest("DescribeResourcePackageProduct", "HTTPS", "POST", "2017-12-14", "AK", $tea.toMap(request), null, runtime), new DescribeResourcePackageProductResponse({}));
  }
  ...
  async describeResourcePackageProduct(request: DescribeResourcePackageProductRequest): Promise<DescribeResourcePackageProductResponse> {
    let runtime = new $Util.RuntimeOptions({ });
    return await this.describeResourcePackageProductEx(request, runtime);
  }
