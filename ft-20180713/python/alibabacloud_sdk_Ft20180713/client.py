...
class Client(alibabacloud_tea_rpc_client_Client):
    ...
    def test_flow_strategy_01with_options(self, request, runtime):
        ...
        return alibabacloud_sdk_Ft20180713_models.TestFlowStrategy01Response().from_map(self.do_request("TestFlowStrategy01", "HTTPS", "PUT", "2018-07-13", "AK", None, request, runtime))
    ...
    def test_http_api_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.TestHttpApiResponse().from_map(self.do_request("TestHttpApi", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def batch_audit_test_01with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.BatchAuditTest01Response().from_map(self.do_request("BatchAuditTest01", "HTTPS", "POST", "2018-07-13", "Anonymous", None, request, runtime))
    ...
    def ft_ip_flow_control_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtIpFlowControlResponse().from_map(self.do_request("FtIpFlowControl", "HTTPS", "POST", "2018-07-13", "Anonymous", None, request, runtime))
    ...
    def ft_dynamic_address_dubbo_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtDynamicAddressDubboResponse().from_map(self.do_request("FtDynamicAddressDubbo", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def ft_dynamic_address_hsf_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtDynamicAddressHsfResponse().from_map(self.do_request("FtDynamicAddressHsf", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def ft_flow_special_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtFlowSpecialResponse().from_map(self.do_request("FtFlowSpecial", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def ftapi_alias_api_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FTApiAliasApiResponse().from_map(self.do_request("FTApiAliasApi", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def ft_eagle_eye_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtEagleEyeResponse().from_map(self.do_request("FtEagleEye", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def ft_param_list_with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtParamListResponse().from_map(self.do_request("FtParamList", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
    ...
    def ft_gated_launch_policy_4with_options(self, request, runtime):
        alibabacloud_tea_util_client_Client.validate_model(request)
        return alibabacloud_sdk_Ft20180713_models.FtGatedLaunchPolicy4Response().from_map(self.do_request("FtGatedLaunchPolicy4", "HTTPS", "POST", "2018-07-13", "AK", None, request, runtime))
