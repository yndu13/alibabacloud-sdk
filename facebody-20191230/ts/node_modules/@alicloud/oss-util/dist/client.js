...
class Client {
    ...
    static getSignature(request, bucketName, accessKeySecret, signatureVersion, addtionalHeaders) {
        let result;
        if (signatureVersion.toUpperCase() === 'V2') {
            result = signature_1.getSignatureV2(request, bucketName, accessKeySecret, addtionalHeaders);
        }
        else {
            result = signature_1.getSignatureV1(request, bucketName, accessKeySecret);
        }
