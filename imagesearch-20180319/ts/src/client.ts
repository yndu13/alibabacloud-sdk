...
export default class Client extends ROA {
  ...
  async searchItemWithOptions(request: SearchItemRequest, runtime: $Util.RuntimeOptions): Promise<SearchItemResponse> {
    ...
    return $tea.cast<SearchItemResponse>(await this.doRequestWithAction("SearchItem", "2018-03-19", "HTTPS", "POST", "AK", `/item/search`, Util.stringifyMapValue($tea.toMap(request.query)), request.headers, null, runtime), new SearchItemResponse({}));
  }
  ...
  async deleteItemWithOptions(request: DeleteItemRequest, runtime: $Util.RuntimeOptions): Promise<DeleteItemResponse> {
    Util.validateModel(request);
    return $tea.cast<DeleteItemResponse>(await this.doRequestWithAction("DeleteItem", "2018-03-19", "HTTPS", "POST", "AK", `/item/delete`, Util.stringifyMapValue($tea.toMap(request.query)), request.headers, null, runtime), new DeleteItemResponse({}));
  }
  ...
  async addItemWithOptions(request: AddItemRequest, runtime: $Util.RuntimeOptions): Promise<AddItemResponse> {
    Util.validateModel(request);
    return $tea.cast<AddItemResponse>(await this.doRequestWithAction("AddItem", "2018-03-19", "HTTPS", "POST", "AK", `/item/add`, Util.stringifyMapValue($tea.toMap(request.query)), request.headers, null, runtime), new AddItemResponse({}));
  }
